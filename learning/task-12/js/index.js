...
function addMporisHotgel100() {
    ...
    .then((docRef) => {
        ...
        mporisButton2.innerHTML += `<h5>
        <button onclick="paymentProcess()" id="rzp-button1" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
        Pay</button></h45>`
        });
    })
    .catch((error) => {
